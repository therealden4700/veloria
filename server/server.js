  ...
  step() {
    ...
    if (this.tick % 4 === 0) {
      for (const p of this.players.values()) {
        ...
        // Только своё: общий признак комнаты рассылал рюкзак всем при любом
        // чужом подборе.
        if (p.bagDirty || (this.world.рюкзакиМеняли && this.world.рюкзакиМеняли.has(p.pid))) {
          p.bagDirty = false;
          this.sendTo(p, {
            t: 'bag',
      ...
      if (this.world.рюкзакиМеняли) this.world.рюкзакиМеняли.clear();
    }
